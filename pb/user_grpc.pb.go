...
type UserClient interface {
	...
	BatchGetUserInfo(ctx context.Context, in *BatchGetUserReq, opts ...grpc.CallOption) (*BatchGetUserResp, error)
...
func (c *userClient) GetUserInfo(ctx context.Context, in *GetUserReq, opts ...grpc.CallOption) (*GetUserResp, error) {
...
func (c *userClient) BatchGetUserInfo(ctx context.Context, in *BatchGetUserReq, opts ...grpc.CallOption) (*BatchGetUserResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userClient) CreateUser(ctx context.Context, in *CreateUserReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type UserServer interface {
	...
	BatchGetUserInfo(context.Context, *BatchGetUserReq) (*BatchGetUserResp, error)
...
func (UnimplementedUserServer) GetUserInfo(context.Context, *GetUserReq) (*GetUserResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserInfo not implemented")
}
func (UnimplementedUserServer) BatchGetUserInfo(context.Context, *BatchGetUserReq) (*BatchGetUserResp, error) {
...
func (UnimplementedUserServer) CreateUser(context.Context, *CreateUserReq) (*emptypb.Empty, error) {
...
func _User_BatchGetUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).BatchGetUserInfo(ctx, req.(*BatchGetUserReq))
	}
	return interceptor(ctx, in, info, handler)
}
