...
func newLike(db *gorm.DB, opts ...gen.DOOption) like {
	...
	_like.TargetType = field.NewInt16(tableName, "target_type")
...
func (l *like) updateTableName(table string) *like {
	...
	l.TargetType = field.NewInt16(table, "target_type")
...
func (l *like) WithContext(ctx context.Context) ILikeDo { return l.likeDo.WithContext(ctx) }
