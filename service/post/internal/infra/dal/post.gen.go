...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.CollectCount = field.NewInt32(tableName, "collect_count")
	_post.ViewCount = field.NewInt32(tableName, "view_count")
...
func (p *post) updateTableName(table string) *post {
	...
	p.ViewCount = field.NewInt32(table, "view_count")
