...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.RootPost = field.NewInt64(tableName, "root_post")
	_comment.ParentComment = field.NewInt64(tableName, "parent_comment")
	_comment.ReplyUID = field.NewInt64(tableName, "reply_uid")
...
type comment struct {
	...
	RootPost      field.Int64
	ParentComment field.Int64
	ReplyUID      field.Int64
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.RootPost = field.NewInt64(table, "root_post")
	c.ParentComment = field.NewInt64(table, "parent_comment")
	c.ReplyUID = field.NewInt64(table, "reply_uid")
...
func (c *comment) fillFieldMap() {
	...
	c.fieldMap["root_post"] = c.RootPost
	c.fieldMap["parent_comment"] = c.ParentComment
	c.fieldMap["reply_uid"] = c.ReplyUID
